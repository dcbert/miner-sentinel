    ...
    def collect_device_data(self, device_id, device_ip):
        ...
        try:
            ...
            """, (
                ...
                system_info.get('vrTemp'), system_info.get('temptarget'), system_info.get('overheat_mode', 0),
                ...
                system_info.get('display'), system_info.get('rotation', 0), system_info.get('invertscreen', 0) == 1,
                system_info.get('displayTimeout', -1),
